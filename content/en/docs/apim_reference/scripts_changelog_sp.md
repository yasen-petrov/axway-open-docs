...
| 7.7.0_SP20200930 | 30-Sep-2020 | {{< alert title="Note" >}}The script has been removed in this release.{{< /alert >}} Updates to API Manager are applied via config upgrade in the Service Pack, through Policy Studio upgrade, or the `projupgrade` and `upgrade-policy` tools. |
| **Version /Service pack** |    **Date**     | **Changes in script** |
